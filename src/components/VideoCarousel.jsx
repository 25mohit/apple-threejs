    ...
    <>
                    ...
                    <div key={list.id} id="slider" className='sm:pr-20 pr-10'>
                        <div className='video-carousel_container'>
                            <div className='w-full h-full flex-center rounded-3xl overflow-hidden bg-black'>
                                ...
                                }} id="video" playsInline={true} muted preload='auto' onLoadedMetadata={(e) => handleLoadedMetaData(i, e)} onEnded={() => 
        ...
        <div className='relative flex-center mt-10'>
            ...
            <button className="control-btn">
                <img src={isLastVideo ? replayImg : !isPlaying ? playImg : pauseImg} onClick={isLastVideo ? () => handleProcess('video-reset') : !isPlaying ? () => handleProcess('play') : () => handleProcess('pause')} alt="" />
            </button>
        </div>
    </>
  )
